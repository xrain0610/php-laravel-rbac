			...
			<div class="ibox-content"> 
				<form method="post" class="form-horizontal" enctype="multipart/form-data"> 
					<div class="form-group"><label class="col-sm-2 control-label">{{trans('common.title')}}</label>
						<div class="col-sm-7"><input type="text" name="title" class="form-control"></div>
					...
					<div class="form-group"><label class="col-sm-2 control-label">{{trans('common.author')}}</label>
						<div class="col-sm-7"><input type="text" name="author" class="form-control"></div>
						@if (\Session::has('errors'))
					...
					<div class="form-group"><label class="col-sm-2 control-label">{{trans('common.text')}}</label>
						<div class="col-sm-7"><input type="text" name="text" class="form-control"></div>
						@if (\Session::has('errors'))
					...
					<div class="form-group"><label class="col-sm-2 control-label">{{trans('common.audio')}}</label>
					...
					<div class="form-group"><label class="col-sm-2 control-label">{{trans('common.img')}}</label>
					...
					<div class="form-group"><label class="col-sm-2 control-label">({{trans('common.canopt')}}){{trans('common.video')}}</label>
					...
					<div class="form-group">
						<div class="col-sm-12 col-sm-offset-5">
							<button class="btn btn-primary" type="submit">{{trans('admin.jing_add')}}</button>
						</div>
					</div>
				</form>
			</div>
